...
MOUNT_DIR = "/media/usb"
USB_CONFIG_FOLDER = os.path.join(MOUNT_DIR, "lushroom")
LUSHROOM_CREDS_PREFIX = "lushroom_creds"
INSTALLED_CREDS_PATH = "/etc/opt/lushroom/lushroom_creds.json"
CONFIG_DIR = "/etc/opt/lushroom"
...
def update_config():
    ...
    for filename in os.listdir(USB_CONFIG_FOLDER):
        if filename.startswith(LUSHROOM_CREDS_PREFIX):
...
if __name__ == '__main__':
    print "running lushroom bootstrap"
    mount_usb()
    update_config()
